    ...
    <main className={styles.pageBody}>
        ...
        <div className={styles.pageContainer}>
            <article className={styles.pageContent}>
                <h2 className={styles.headingLink}><Link href="/main/practice-areas/impaired-driving">Impaired Driving</Link></h2>
                ...
                <h2 className={styles.headingLink}><Link href="/main/practice-areas/refusing-a-breathalyzer-or-drug-test">Refusing a Breathalyzer or Drug Test</Link></h2>
                ...
                <h2 className={styles.headingLink}><Link href="/main/practice-areas/driving-over-08">Driving Over .08</Link></h2>
                ...
                <h2 className={styles.headingLink}><Link href="/main/practice-areas/dangerous-driving">Dangerous Driving</Link></h2>
                ...
                <h2 className={styles.headingLink}><Link href="/main/practice-areas/failure-to-stop-at-an-accident">Failure to Stop at an Accident</Link></h2>
                <p><strong><Link href="/main/practice-areas/failure-to-stop-at-an-accident">Failure to stop at the scene of an accident</Link></strong>, especially when someone is injured or there is significant property damage, is a serious offence. It is mandatory to stop, provide your information, and offer assistance if needed.</p>
                ...
                <h2 className={styles.headingLink}><Link href="/main/practice-areas/flight-from-a-peace-officer">Flight From a Peace Officer</Link></h2>
