    ...
    <main className={styles.pageBody}>
        ...
        <div className={styles.pageContainer}>
            <article className={styles.pageContent}>
                <p><Link href="/main/practice-areas/impaired-driving">Impaired driving</Link> in Canada is regarded with severe gravity and carries hefty penalties that can have long-lasting effects on your life. Knowing the potential outcomes of a conviction is vital for anyone facing these charges.</p>
                <p className={styles.contentBreak}>The penalties for <Link href="/main/practice-areas/impaired-driving">impaired driving</Link> vary depending on the nature of the offence and the specifics of each case. Seeking legal counsel is essential to navigate these complexities and mitigate potential consequences.</p>
                ...
                <p className={styles.contentBreak}><Link href="/main/practice-areas/impaired-driving">Learn more about Impaired Driving Charges</Link></p>
                

                <h2><Link href="/main/practice-areas/refusing-a-breathalyzer-or-drug-test">Refusing a Breathalyzer or Drug Test</Link></h2>
                <p><strong>Minimum and Maximum Penalties</strong></p>
                    <ul className={`${styles.contentList}`}>
                ...
                <p className={styles.contentBreak}><Link href="/main/practice-areas/refusing-a-breathalyzer-or-drug-test">Learn more about Refusing a Breathalyzer or Drug Test Charges</Link></p>

                <h2><Link href="/main/practice-areas/driving-over-08">Driving Over .08</Link></h2>
                <p><strong>Minimum and Maximum Penalties</strong></p>
                    <ul className={`${styles.contentList}`}>
                ...
                <p className={styles.contentBreak}><Link href="/main/practice-areas/driving-over-08">Learn more about Driving Over .08 Charges</Link></p>

                <h2><Link href="/main/practice-areas/dangerous-driving">Dangerous Driving</Link></h2>
                <p><strong>Minimum and Maximum Penalties</strong></p>
                    <ul className={`${styles.contentList}`}>
                ...
                <p className={styles.contentBreak}><Link href="/main/practice-areas/dangerous-driving">Learn more about Dangerous Driving Charges</Link></p>

                <h2><Link href="/main/practice-areas/failure-to-stop-at-an-accident">Failure to Stop at an Accident</Link></h2>
                <p><strong>Minimum and Maximum Penalties</strong></p>
                    <ul className={`${styles.contentList}`}>
                ...
                <p className={styles.contentBreak}><Link href="/main/practice-areas/failure-to-stop-at-an-accident">Learn more about Failure to Stop at an Accident Charges</Link></p>

                <h2><Link href="/main/practice-areas/flight-from-a-peace-officer">Flight From a Peace Officer</Link></h2>
                <p><strong>Minimum and Maximum Penalties</strong></p>
                    <ul className={`${styles.contentList}`}>
                        <li><strong>Summary Conviction:</strong> Up to 2 years less a day in jail.</li>
                        <li><strong>Indictable Conviction:</strong> Up to 10 years imprisonment.</li>
                    </ul>
                <p className={styles.contentBreak}><Link href="/main/practice-areas/flight-from-a-peace-officer">Learn more about Flight From a Peace Officer Charges</Link></p>
